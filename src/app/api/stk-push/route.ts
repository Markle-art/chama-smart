...
export async function POST(req: NextRequest) {
  try {
    ...
    const tokenRes = await fetch('https://sandbox.safaricom.co.il/oauth/v1/generate?grant_type=client_credentials', {
    ...
    const stkRes = await fetch('https://sandbox.safaricom.co.il/mpesa/stkpush/v1/query', {
      method: 'POST',
      headers: {
